...
exports.handler = async (event) => {
  ...
  const responses = {
    ...
    experience: 'Experience:\n--------------------\nLead Software Engineer, AWS Professional Services\nJan 2026 to Present\n• Led delivery of a cloud platform automating security scanning and release governance\n• Shipped a React console for remediation and pipeline re-runs with cross-functional teams\n• Integrated four scanners into CI/CD with feedback on every code change\n• Built deployment gates that block risky releases automatically\n• Delivered Keycloak RBAC, dashboards, and audit exports leadership uses\n\nCloud Platform Engineer, COSMOS\nStrategic Business Systems (SBS) · Jul 2025 to Jan 2026\n• Network Firewall policies across 500+ approved ranges\n• Standardized landing zones across 64+ accounts, 40% faster provisioning\n• Aligned architects, app teams, and security on repeatable AWS patterns',
